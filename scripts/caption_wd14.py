...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--force_download", action="store_true", help="force downloading wd14 tagger models"
    )
    ...
    parser.add_argument("--caption_extension", type=str, default=".keyword", help="extension of caption file")
    parser.add_argument(
        "--general_threshold",
        type=float,
        default=0.35,
